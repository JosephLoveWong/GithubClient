...
import com.promiseland.githubclient.ui.repositoryDetail.di.RepositoryDetailSubComponent;
...
public interface UserSubComponent {
    ...
    RepositoryDetailSubComponent plus(RepositoryDetailModule module);
}
